...
<body>
    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <button class="add" onclick="exportTableToExcel('attendaceTable', '<?php echo $unitCode . '_on_' . date('Y-m-d'); ?>','<?php echo $coursename ?>', '<?php echo $unitname ?>')">Xuất DS dưới dạng Excel</button>
